...
namespace ObjParser
{
    public class Obj
    {
		...
		public List<Vector> NormalVectorList;
	    ...
	    public Obj()
	    {
            ...
            NormalVectorList = new List<Vector>();
	    }
	    ...
	    private void WriteHeader(StreamWriter writer, string[] headerStrings)
	    {
	        ...
	        {
	            writer.WriteLine("# Generated by ObjParser-tmp");
	            return;
	        }
		    ...
		    if (parts.Length > 0)
		    {
			    switch (parts[0])
			    {
				    ...
				    case "vn":
					    ...
					    NormalVectorList.Add(vn);
					    vn.Index = NormalVectorList.Count();
					    break;
